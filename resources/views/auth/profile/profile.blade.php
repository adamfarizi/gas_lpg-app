                        ...
                        <form role="form text-left" action="{{ url('admin/profile', $admins->id_admin) }}"
                            ...
                            <div class="text-center">
                                <button type="button" name="modal" class="btn bg-gradient-primary w-100 mt-4 mb-0"
                                    data-bs-toggle="modal" data-bs-target="#exampleModalMessage">Change Password</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <form action="{{ route('password.action') }}" method="post" role="form text-left">
                                ...
                                <div class="text-center">
                                    <button type="submit" name="submit"
                                        class="btn bg-gradient-success w-100 mt-4 mb-0">Change Password</button>
                                </div>

                                <div class="text-center">
                                    <a type="button" name="modal" data-bs-dismiss="modal"
                                        class="btn bg-gradient-primary w-100 mt-4 mb-0">Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
