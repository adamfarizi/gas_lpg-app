...
@section('content')
                        ...
                        <div class="table-responsive p-0" style="max-height: 300px; overflow-y: auto;">
                            ...
                            <table id="table_konfirmasiPembayaran" class="table align-items-center mb-0">
                                ...
                                @foreach ($pembayaran as $transaksi)
                                    <form action="{{ route('update_pembayaran', $transaksi->id_transaksi) }}"
                                        method="POST" id="formUpdatePembayaran_{{ $transaksi->id_transaksi }}">
                                        @csrf
                                        @method('PUT')
                                                        ...
                                                        <div class="d-flex ps-3">
                                                            <div class="form-check pe-2">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    id="checkbox_{{ $transaksi->id_transaksi }}"
                                                                    data-jumlah-gas="{{ $transaksi->jumlah_transaksi }}">
                                                            </div>
                                            ...
                                            <tr class="text-dark">
                                                ...
                                                <td class="align-middle text-sm text-center">
                                                    <a href="#" type="button" data-id="#"
                                                        data-bs-toggle="modal" data-bs-target="#more-info">
                                                        <span class="badge badge-sm bg-gradient-info"><i
                                                                class="fa fa-solid fa-info me-2"
                                                                style="color: #ffffff;"></i>More Info</span>
                                                    </a>
                                                </td>
                                                <td class="align-middle text-sm text-center pt-4">
                                        ...
                                        <tr class="text-dark">
                                            ...
                                            <td class="align-middle text-center ">
                                                <button type="button"class="btn bg-gradient-warning btn-icon btn-sm ps-3"
                                                    ...
                                                    id="modalButton">
                                                    <span><i
                                                            class="fa fa-solid fa-info me-3"style="color: #ffffff;"></i></span>
                                                    Cek Status
                                                </button>
                                            </td>
                                        </tr>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="modal fade" id="more-info" tabindex="-1" role="dialog" aria-labelledby="modal-default"
                aria-hidden="true">
