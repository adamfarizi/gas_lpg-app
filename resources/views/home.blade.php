    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Guest</a></li>
        ...
        <div class="ms-md-auto pe-md-3 d-flex align-items-center">
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0" href="{{ route('register') }}">Sign Up Free</a>
            </li>
            <li class="nav-item d-xl-none ps-3 d-flex align-items-center ms-7">
                ...
                <tbody>
                    ...
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">GasTrack</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="avatar-group mt-2">
                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ryan Tompson">
                          <img src="{{ asset('ssets/img/team-4.jpg') }}a" alt="user5">
                        </a>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
