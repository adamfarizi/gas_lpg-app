    ...
    <section>
      <div class="title" style="background-image: url(/storage/img/Home/Hero.png)">
        <div class="container-fluid">
          <div class="container">
            <div class="row">
              <div class="col-lg-7 d-flex flex-column justify-content-center pt-5">
                ...
                <div class="search-box mt-2 pt-5">
                  <p>Enter your tracking number</p>
                  <input class="search-input" type="text" name="" placeholder="Tracking No.">
