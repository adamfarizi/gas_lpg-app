    ...
    <div class="card-header pb-0 text-left">
        ...
        <div class="card-body">
            ...
            @if($errors->any())
                ...
                @endforeach
            @endif
        <form role="form text-left" action="{{ url('agen/dashboard', $users->user_id) }}" method="POST">    
            @csrf
            @method('PUT')  
            <label>Name</label>
            ...
            <div class="text-center">
                <input type="submit" name="submit"  class="btn bg-gradient-primary w-100 mt-4 mb-0" values="Update">
            </div>
        </form>
    </div>
@endsection