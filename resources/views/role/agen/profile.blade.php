...
@section('sidebar')
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                <a class="nav-link" href="{{ url('agen/dashboard') }}">
...
<div class="container-fluid">
    ...
    <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
        ...
        <div class="col-auto">
            ...
            <img src="../assets/img/local/profil.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
        </div>
        ...
        <div class="col-12 col-xl-6">
            <div class="card h-100">
                ...
                <div class="card-body p-3">
                    ...
                    <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp; H. Maguier</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; (44) 123 1234 123</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong> &nbsp; alecmaguire@mail.com</li>
